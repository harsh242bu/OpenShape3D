...
def single_uncompress(file, dest="mnt/data"):
	hf_hub_download(repo_id="OpenShape/openshape-training-data", filename=file, repo_type="dataset", 
...
print("3D-FUTURE.tar.gz, ABO.tar.gz, ShapeNet.tar.gz....")

for i in range(160):
	pool.apply_async(single_uncompress, ("Objaverse/000-%03d.tar.gz" % i,))
print("Objaverse/000-000.tar.gz to Objaverse/000-159.tar.gz....")
